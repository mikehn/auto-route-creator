...
var ROUTES2 = {
  cars: (_cars2 = {}, _defineProperty(_cars2, PROTOCOL, _RouteCreator.METHOD.GET), _defineProperty(_cars2, "id", (_id4 = {}, _defineProperty(_id4, DYNAMIC, true), _defineProperty(_id4, QUERY, getCarsQueryParams), _defineProperty(_id4, "passenger", (_passenger2 = {}, _defineProperty(_passenger2, PROTOCOL, _RouteCreator.METHOD.GET), _defineProperty(_passenger2, QUERY, passengersQueryParams), _defineProperty(_passenger2, "id", _defineProperty({}, DYNAMIC, true)), _passenger2)), _defineProperty(_id4, "speed1", (_speed3 = {}, _defineProperty(_speed3, NAME, "speed"), _defineProperty(_speed3, PROTOCOL, _RouteCreator.METHOD.GET), _defineProperty(_speed3, QUERY, getSpeedQueryParams), _speed3)), _defineProperty(_id4, "speed2", (_speed4 = {}, _defineProperty(_speed4, NAME, "speed"), _defineProperty(_speed4, PROTOCOL, _RouteCreator.METHOD.POST), _defineProperty(_speed4, BODY, speedPostBody), _defineProperty(_speed4, QUERY, speedPostQuery), _speed4)), _id4)), _cars2)
};
(0, _RouteCreator.initRoutes)(ROUTES1);
(0, _RouteCreator.initRoutes)(ROUTES2);
console.log("path ", (0, _RouteCreator.getPath)(ROUTES1.cars.id, {
  pathArgs: "MIKE",
