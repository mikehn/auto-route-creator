...
var _passenger, _speedGet, _speedPost, _speedPut, _id2, _cars, _passenger2, _speedGet2, _speedPost2, _id4, _cars2, _id5, _cars3, _MOCK_RESPONSE_DEFINI, _pathArgs2;
...
})), _defineProperty(_id5, "speedPut", _defineProperty({}, RESPONSE, {})), _id5)), _defineProperty(_cars3, "permissions", _defineProperty({}, RESPONSE, {
  template: function template() {
...
mock(ROUTES1, {
  defaultListSize: 4,
  interceptor: function interceptor(req, res, next, mData) {
    if (mData[req.url]) {
